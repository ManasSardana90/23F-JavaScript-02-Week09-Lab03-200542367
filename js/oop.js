...
function Hamburger(options) {
    ...
    this.description = function() {
        return `This hamburger has a ${this.bunType} bun with ${this.pattyCount} ${this.meat} patty, ` +
            `topped with ${this.cheeses.join(", ")}, garnished with ${this.garnishes.join(", ")}, ` +
            `and special sauces like ${this.sauces.join(", ")}. Extras include: ${this.extras.join(", ")}.`;
    };
}
...
alert(myHamburger.description()); // This would output the description of the hamburger
